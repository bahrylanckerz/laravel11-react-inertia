...
export default function Index({ auth, projects, queryParams = null, successMessage }) {
        ...
        <AuthenticatedLayout
            ...
            header={
                <div className="flex items-center justify-between">
                    ...
                    <Link href={route('project.create')} className="bg-emerald-500 hover:bg-emerald-600 py-1 px-3 text-white rounded shadow transition-all">Add New</Link>
                </div>
            }
        >
            <Head title="Projects" />
                                    ...
                                    <tbody>
                                        {
                                            projects.data.map((project) => (
                                                <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700" key={project.id}>
                                                    ...
                                                    <td className="px-3 py-2">
                                                        <Link href={route('project.show', project)} className="text-blue-500 hover:underline">
                                                            {project.name}
                                                        </Link>
                                                    </td>
                                                    <td className="px-3 py-2">
