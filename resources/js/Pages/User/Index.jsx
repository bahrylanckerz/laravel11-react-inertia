...
export default function Index({ auth, users, queryParams = null, successMessage }) {
        ...
        <AuthenticatedLayout
            ...
            header={
                <div className="flex items-center justify-between">
                    ...
                    <Link href={route('user.create')} className="bg-emerald-500 hover:bg-emerald-600 py-1 px-3 text-white rounded shadow transition-all">Add New</Link>
                </div>
            }
        >
            <Head title="Users" />
